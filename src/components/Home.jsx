...
function Home({ clicked }) {
  return (
    <>
      ...
      <Parallax strength={isMobile ? 0 : -200} bgImage={isMobile ? bgMobile: bg} blur={{ min: 10, max: -10 }}>
        <div className={`h-screen flex flex-col justify-center ${isMobile ? "text-black" : "text-white"} text-center sm:text-left sm:px-24 gap-12`}>
          <p className="tracking-widest font-normal" data-aos-duration="1000"
                data-aos="fade-right">
            FÁBRICA DE ABERTURAS A MEDIDA EN PILAR
          </p>
          <h1 data-aos-delay="200" data-aos-duration="1000"
                data-aos="fade-right" className="text-6xl font-semibold drop-shadow-md">
            Tecno Aberturas DC
          </h1>
          <small data-aos-delay="400" data-aos-duration="1000"
                data-aos="fade-right" className="text-lg">
            Fabricantes de aberturas de alta prestación, modelos estándar y a
            medida. Venta y colocación.{" "}
          </small>
          <button data-aos-delay="600" data-aos-duration="1000"
                data-aos="fade-right" className="self-center btn btn-1 hover-filled-slide-right m-0 sm:self-start"> <span>Ver productos</span></button>
        </div>
      </Parallax>
      <Parallax strength={isMobile ? 0 : -200} bgImage={isMobile ? bgMobile2: bg2} blur={{ min: 10, max: -10 }}>
        <div className={`h-screen flex flex-col justify-center ${isMobile ? "text-black" : "text-white"} text-center sm:text-left sm:px-24 gap-12`}>
          <p data-aos-duration="1000"
                data-aos="fade-right" className="tracking-widest font-normal">
