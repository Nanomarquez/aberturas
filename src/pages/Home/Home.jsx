...
function Home({ clicked }) {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-gradient-linear-custom">
      <Slider {...settings}>
        {/* imagen 1 */}
        <section className="slider bg-[url('/images/background_img1.png')] h-[100vh] bg-cover bg-center">
            ...
            {!clicked && (
              <div className="flex flex-col items-center justify-center h-screen">
                <h4
                  ...
                  data-aos="zoom-in"
                  className="text-[30px] lg:text-7xl drop-shadow-md font-bold text-[#ECECEC] lg:text-white p-4"
                >
        ...
        {/* imagen 2 */}
        <section className="slider bg-[url('/images/pexels-alena-darmel-7642100.jpg')] h-[100vh] bg-cover bg-center">
          <div className="content">
            {!clicked && (
              <div className="flex flex-col items-start justify-center h-screen ml-10 lg:ml-20">
                ...
                <ul className="text-2xl mt-14 lg:mt-20 lg:text-5xl drop-shadow-md font-medium bg-gradient-blue-teal custom-list">
                  ...
                  <li className=" my-1 text-slate-400">CONFORT</li>
                </ul>
                <Link to={"/contacto"}>
                  <button
                    data-aos-delay="500"
      ...
      >
        ...
        >
          <p
            ...
            data-aos="fade-right"
          >
            En Tecno Aberturas DC somos líderes en fabricación, venta y
            colocación de una amplia variedad de aberturas de alta calidad y
            personalizadas, desde ventanas y puertas corredizas, cortinas,
            sistemas de cerramientos innovadores, fachadas espejadas, barandas y
            pérgolas a medida, así como proyectos de herrería en general. Con
            una experiencia sólida de más de 20 años en el mercado y un enfoque
            centrado en la tecnología y el diseño personalizado, nos enorgullece
            ofrecer soluciones excepcionales para embellecer y asegurar tus
            espacios.
          </p>

          <Link to={"/nosotros"} className=" max-w-0">
            <button
              data-aos-delay="600"
              data-aos-duration="1000"
              data-aos="fade-right"
